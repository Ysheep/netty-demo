...
import com.ysheep.rpc.discovery.ServiceDiscovery;
import com.ysheep.rpc.discovery.ServiceDiscoveryImpl;
import com.ysheep.rpc.dto.InvokeMessage;
import com.ysheep.rpc.loadbalance.RandonLoadBalance;
...
public class RPCProxy {
    ...
    private static Object rpcInvoke(Class clzz,Method method, Object[] args) throws Exception{
        ...
        try {
            ...
            String servicePath = loadBalance.choose(discovery.discovery(clzz.getName()));
            if (servicePath == null) {
                throw new Exception("未发现服务");
            }
            String ip = servicePath.split(":")[0];
            String portStr = servicePath.split(":")[1];
